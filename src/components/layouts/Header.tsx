...
export default function Header(props: { className?: string }) {
    return (
        <div className={cn('z-50 fixed top-0 flex justify-center items-center w-full', props.className)}>
            <div className="relative flex h-fit w-full max-w-[350px] items-center justify-between gap-0.5 rounded-lg bg-transparent p-2 backdrop-blur-md sm:justify-between">
